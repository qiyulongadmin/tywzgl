                            ...
                            <div class="tabbable" >
                                ...
                                <div class="bs-bars pull-left">
                                    <div id="toolbar" class="btn-group">
										<a href="{{url('admin/pics/'.$pic_type->id.'/pics/create')}}" style="color:#333">
                                ...
                                <table id="tb_departments" class="table table-hover table-striped" style="margin-top: 0px;">
                                    <tbody>
                                    	...
                                    	<tr>
                                    		<td>{{$i}}</td>
                                            <td>{{$v->title}}</td>
                                    		<td><img src="{{asset($v->src)}}" style="width: 100px;height: 80px;" alt=""></td>
                                            <td class="hidden-480">
                                            @if($pic_type->type==1)
                                                单图片
                                                @else 多图片
                                    		...
                                    		<td>
                                    			<div class="hidden-sm hidden-xs btn-group">
                                                    <form style="float: left; margin-left: 2px;" action="{{url('admin/pics/'.$pic_type->id.'/pics/edit',['ids'=>$v->id])}}" method= "get">
                                                        <input class="btn btn-xs btn-info" type="submit" value="编辑" />
                                                    </form>
                                                    <form style="float: right;margin-left: 2px;" action="{{url('admin/pics/'.$pic_type->id.'/pics',['ids'=>$v->id])}}" method= "post">
