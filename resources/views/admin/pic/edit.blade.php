                                        			...
                                        			<div class="col-xs-12">
                                                        ...
                                                        {{--消息提示结束--}}
                                                            <div id="edit" class="tab-pane active">
                                                                <div id="alert"></div>
                                                                <form class="form-horizontal" id="sample-form" enctype="multipart/form-data" method="post" action="{{url('admin/pics/'.$id.'/pics',['ids'=>$pics->id])}}">
                                                                    {{ csrf_field() }}
                                                                    @csrf
                                                                    @method('PATCH')
                                                                    {{--
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-5 inline help-block">
                                                                            <span class="block input-icon input-icon-right">
                                                                                <input type="number" name="pics[show_order]" value="{{$pics->show_order}}" id="show_order" class="width-100" >
                                                                                <i class="icon-leaf"></i>
                                                                            </span>
                                                                        </div>
                                                                   ...
                                                                   <div class="form-group">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           <span class="block input-icon input-icon-right">
                                                                               <input type="text" name="pics[title]" value="{{$pics->title}}" required="" id="title" class="width-100">
                                                                               <i class="icon-leaf"></i>
                                                                           </span>
                                                                       </div>
                                                                   ...
                                                                   <div class="form-group">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           ...
                                                                           （logo原图：<img src="{{asset($pics->src)}}" style="width: 100px;height: 80px;" alt="">）
                                                                           </span>
                                                                       </div>
                                                                       <div class="help-block col-xs-12 col-sm-reset inline red">
                                                                           *(必填)
                                                                   ...
                                                                   <div class="form-group">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           <span class="block input-icon input-icon-right">
                                                                               <input type="text" name="pics[src]" value="{{$pics->src}}" required="" id="src" class="width-100">
                                                                               <i class="icon-leaf"></i>
                                                                           </span>
                                                                       </div>
                                                                       <div class="help-block col-xs-12 col-sm-reset inline red">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           <span class="block input-icon input-icon-right">
                                                                               <div class="radio inline">
                                                                                   <label>
                                                                                       <input type="radio" name="show_tag" value="0" title="0" class="ace" {{$pics->show_tag==0?"checked":''}}>
                                                                                       <span class="lbl"> 显示 </span>
                                                                                   </label>
                                                                               </div>
                                                                               <div class="radio inline">
                                                                                   <label>
                                                                                       <input type="radio" name="show_tag" value="1" title="1" class="ace" {{$pics->show_tag==1?"checked":''}}>
