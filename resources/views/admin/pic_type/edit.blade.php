                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="tabbable">
                                                        ...
                                                        <div id="edit" class="tab-pane active">
                                                            <div id="alert"></div>
                                                            <form class="form-horizontal" id="sample-form" method="post" action="{{url('admin/pic_type',['id'=>$pic_type->id])}}">
                                                                {{ csrf_field() }}
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-5 inline help-block">
                                                                        <span class="block input-icon input-icon-right">
                                                                            <input type="number" name="Pic_type[show_order]" value="{{$pic_type->show_order}}" id="show_order" class="width-100" >
                                                                            <i class="icon-leaf"></i>
                                                                        </span>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-5 inline help-block">
                                                                        <span class="block input-icon input-icon-right">
                                                                            ...
                                                                            <div class="radio inline">
                                                                                <label>
                                                                                    <input type="radio" name="Pic_type[type]" value="1" title="1" class="ace" {{$pic_type->type==1?"checked":''}}>
                                                                                    <span class="lbl"> 单图片 </span>
                                                                                </label>
                                                                            </div>
                                                                            <div class="radio inline">
                                                                                <label>
                                                                                    <input type="radio" name="Pic_type[type]" value="2" title="2" class="ace" {{$pic_type->type==2?"checked":''}}>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-5 inline help-block">
                                                                        <span class="block input-icon input-icon-right">
                                                                            <input type="text" name="Pic_type[name]" value="{{$pic_type->name}}" required="" id="name" class="width-100">
                                                                            <i class="icon-leaf"></i>
                                                                        </span>
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="width" class="col-xs-12 col-sm-3 control-label no-padding-right">图片宽度</label>

                                                                    <div class="col-xs-12 col-sm-5 inline help-block">
                                                                        <span class="block input-icon input-icon-right">
                                                                            <input type="number" name="Pic_type[width]" value="{{$pic_type->width}}" id="width" class="width-100">
                                                                            <i class="icon-leaf"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="help-block col-xs-12 col-sm-reset inline red">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="height" class="col-xs-12 col-sm-3 control-label no-padding-right">图片高度</label>

                                                                    <div class="col-xs-12 col-sm-5 inline help-block">
                                                                        <span class="block input-icon input-icon-right">
                                                                            <input type="number" name="Pic_type[height]" value="{{$pic_type->height}}" id="height" class="width-100">
                                                                            <i class="icon-leaf"></i>
                                                                        </span>
                                                                    </div>
                                                                    <div class="help-block col-xs-12 col-sm-reset inline red">
