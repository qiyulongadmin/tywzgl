                                ...
                                <table id="tb_departments" class="table table-hover table-striped" style="margin-top: 0px;">
                                    <tbody>
                                        ...
                                        <tr data-index="{{$i-1}}" data-uniqueid="{{$i}}">
                                            ...
                                            <td style=""><span class="label label-sm label-warning">{{$v->add_user}}</span></td>
                                        ...
                                        var TableInit = function () {
                                            ...
                                            oTableInit.Init = function () {
                                                $('#tb_departments').bootstrapTable({
                                                    ...
                                                    {{--{
                                                        field:'id',
                                                        formatter:function(value,row,index){manager/auth,&quot;+value+&quot;
                                                            var a = "";
                                                            a += '<a class="green" style="method= get" href="&quot;admin/manager/auth&quot;,[&quot;id&quot;=>$v->id]">授权</a> ';
                                                            a += '<a class="blue" href="edit?id=">修改</a> ';
                                                            a += '<a class="red" onclick="return del()" href="index?id=">删除</a>';
                                                            return a;
                                                        },
                                                        title: '操作',
                                                    },--}}
