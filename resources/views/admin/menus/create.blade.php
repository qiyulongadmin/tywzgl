                    ...
                    <div class="col-sm-6" style="width: 100%;">
                        <div class="tabbable" >
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <li class="active">
                                    <a href="{{url('admin/menus/'.$id.'/menus/create')}}">
                                        内容分类添加
                                    </a>
                                </li>
                            </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <div id="edit" class="tab-pane active">
                                                    <form class="form-horizontal" id="sample-form" method="post" action="{{url('admin/menus/'.$id.'/menus')}}">
                                                        {{ csrf_field() }}
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="number" name="menus[show_order]" id="show_order" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="text" name="menus[name]" required="" id="name" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
                                                            <div class="help-block col-xs-12 col-sm-reset inline red">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="text" name="menus[link_addr]" id="link_addr" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
                                                            <div class="help-block col-xs-12 col-sm-reset inline">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <div class="radio inline">
                                                                        <label>
                                                                            <input type="radio" name="menus[show_tag]" value="0" title="0" class="ace" checked="true" id="show_tag">
                                                                            <span class="lbl"> 显示 </span>
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio inline">
                                                                        <label>
                                                                            <input type="radio" name="menus[show_tag]" value="1" title="1" class="ace">
