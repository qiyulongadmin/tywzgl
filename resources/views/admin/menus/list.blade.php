                            ...
                            <div class="tabbable" >
                                ...
                                <div class="bs-bars pull-left">
                                    <div id="toolbar" class="btn-group">
                                        <a href="{{url('admin/menus/'.$id.'/menus/create')}}" style="color:#333">
                                        ...
                                        @if($id!=0)
                                        <a href="{{url('admin/menus/'.$menus_type.'/menus')}}" style="color:#333;">
                                    	...
                                    	<tr>
                                    		...
                                    		<td>
                                    			<div class="hidden-sm hidden-xs btn-group">
                                                    <form style="float: left; margin-left: 2px;" action="{{url('admin/menus/'.$id.'/menus/edit',['ids'=>$v->id])}}" method= "get">
                                                        <input class="btn btn-xs btn-info" type="submit" value="编辑" />
                                                    </form>
                                                    @if($v->type==0)
                                                    <form style="float: right; margin-left: 2px;" action="{{url('admin/menus/'.$v->id.'/menus')}}" method= "get">
                                                        <input class="btn btn-xs btn-info" type="submit" value="下级分类" />
                                                    </form>
                                                    @endif
                                                    <form style="float: right;margin-left: 2px;" action="{{url('admin/menus/'.$id.'/menus',['ids'=>$v->id])}}" method= "post">
