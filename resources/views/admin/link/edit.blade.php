                        ...
                        <div class="col-sm-6" style="width: 100%;">
                            <div class="tabbable" >
                                ...
                                <ul class="nav nav-tabs" id="myTab">
                                    <li class="">
                                        <a href="{{url('admin/links/'.$id.'/links')}}">
                                        			...
                                        			<div class="col-xs-12">
                                                        ...
                                                        {{--消息提示结束--}}
                                                            <div id="edit" class="tab-pane active">
                                                                <div id="alert"></div>
                                                                <form class="form-horizontal" id="sample-form" enctype="multipart/form-data" method="post" action="{{url('admin/links/'.$id.'/links',['ids'=>$links->id])}}">
                                                                    {{ csrf_field() }}
                                                                    @csrf
                                                                    @method('PATCH')
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-5 inline help-block">
                                                                            <span class="block input-icon input-icon-right">
                                                                                <input type="number" name="links[show_order]" value="{{$links->show_order}}" id="show_order" class="width-100" >
                                                                                <i class="icon-leaf"></i>
                                                                            </span>
                                                                        </div>
                                                                   ...
                                                                   <div class="form-group">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           <span class="block input-icon input-icon-right">
                                                                               <input type="text" name="links[title]" value="{{$links->title}}" required="" id="title" class="width-100">
                                                                               <i class="icon-leaf"></i>
                                                                           </span>
                                                                       </div>
                                                                   ...
                                                                   <div class="form-group">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           ...
                                                                           （logo原图：<img src="{{asset($links->pic)}}" style="width: 100px;height: 80px;" alt="">）
                                                                           </span>
                                                                       </div>
                                                                       <div class="help-block col-xs-12 col-sm-reset inline red">
                                                                           *(必填)
                                                                   ...
                                                                   <div class="form-group">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           <span class="block input-icon input-icon-right">
                                                                               <input type="text" name="links[src]" value="{{$links->src}}" required="" id="src" class="width-100">
                                                                               <i class="icon-leaf"></i>
                                                                           </span>
                                                                       </div>
                                                                       <div class="help-block col-xs-12 col-sm-reset inline red">
                                                                       ...
                                                                       <div class="col-xs-12 col-sm-5 inline help-block">
                                                                           <span class="block input-icon input-icon-right">
                                                                               <div class="radio inline">
                                                                                   <label>
                                                                                       <input type="radio" name="links[show_tag]" value="0" title="0" class="ace" {{$links->show_tag==0?"checked":''}}>
                                                                                       <span class="lbl"> 显示 </span>
                                                                                   </label>
                                                                               </div>
                                                                               <div class="radio inline">
                                                                                   <label>
                                                                                       <input type="radio" name="links[show_tag]" value="1" title="1" class="ace" {{$links->show_tag==1?"checked":''}}>
