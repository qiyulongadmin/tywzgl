                    ...
                    <div class="col-sm-6" style="width: 100%;">
                        <div class="tabbable" >
                            ...
                            <ul class="nav nav-tabs" id="myTab">
                                ...
                                <li class="active">
                                    <a href="{{url('admin/link_type/create')}}">
                                        链接类型添加
                                    </a>
                                </li>
                            </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <div id="edit" class="tab-pane active">
                                                    <form class="form-horizontal" id="sample-form" method="post" action="{{url('admin/link_type')}}">
                                                        {{ csrf_field() }}
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="number" name="link_type[show_order]"  id="show_order" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label for="show_tag" class="col-xs-12 col-sm-3 control-label no-padding-right">链接分类类型</label>

                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <div class="radio inline">
                                                                        <label>
                                                                            <input type="radio" name="link_type[type]" value="1" title="1" class="ace" checked="true" id="show_tag">
                                                                            <span class="lbl"> 单图片 </span>
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio inline">
                                                                        <label>
                                                                            <input type="radio" name="link_type[type]" value="2" title="2" class="ace">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="text" name="link_type[name]" required="" id="name" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
