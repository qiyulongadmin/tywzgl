                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <div id="edit" class="tab-pane active">
                                                    <form class="form-horizontal" id="sample-form" enctype="multipart/form-data" method="post" action="{{url('admin/links/'.$id.'/links')}}">
                                                        {{ csrf_field() }}
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="number" name="links[show_order]"  id="show_order" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="text" name="links[title]" required="" id="title" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="text" name="links[src]" required="" id="src" class="width-100">
                                                                    <i class="icon-leaf"></i>
                                                                </span>
                                                            </div>
                                                            <div class="help-block col-xs-12 col-sm-reset inline red">
                                                            ...
                                                            <div class="col-xs-12 col-sm-5 inline help-block">
                                                                <span class="block input-icon input-icon-right">
                                                                    <div class="radio inline">
                                                                        <label>
                                                                            <input type="radio" name="links[show_tag]" value="0" title="0" class="ace" checked="true" id="show_tag">
                                                                            <span class="lbl"> 显示 </span>
                                                                        </label>
                                                                    </div>
                                                                    <div class="radio inline">
                                                                        <label>
                                                                            <input type="radio" name="links[show_tag]" value="1" title="1" class="ace">
