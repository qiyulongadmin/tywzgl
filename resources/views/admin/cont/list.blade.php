                                        ...
                                        <span class="label label-sm label-warning">{{$v->add_user}}</span>
                                            ...
                                            <td style="">
                                                <div class="hidden-sm hidden-xs btn-group">
                                                    <form style="float: left; margin-left: 2px;" action="{{url('admin/conts/'.$id.'/conts/'.$id2.'/conts/edit',['ids'=>$v->id])}}" method= "get">
                                                        <input class="btn btn-xs btn-info" type="submit" value="编辑" />
                                                    </form>
                                                    <form style="float: right;margin-left: 2px;" action="{{url('admin/conts/'.$id.'/conts/'.$id2.'/conts',['ids'=>$v->id])}}" method= "post">
