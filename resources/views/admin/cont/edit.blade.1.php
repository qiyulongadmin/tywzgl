                            ...
                            <div class="tabbable" >
                                ...
                                <ul class="nav nav-tabs" id="myTab">
                                    @if($type==0&&$type==1&&$type==2)
                                        ...
                                        <li>
                                            <a href="{{url('admin/conts/'.$id.'/conts/'.$id2.'/conts/create')}}">
                                                内容添加
                                            </a>
                                        </li>
                                    @endif
                                        			...
                                        			<div class="col-xs-12">
                                                        ...
                                                        {{--消息提示结束--}}
                                                            <div id="edit" class="tab-pane active">
                                                                <div id="alert"></div>
                                                                <form class="form-horizontal" id="sample-form" enctype="multipart/form-data" method="post" action="{{url('admin/conts/'.$id.'/conts/'.$id2.'/conts',['ids'=>$conts->id])}}">
                                                                    {{ csrf_field() }}
                                                                    @csrf
                                                                    @method('PATCH')
                                                                    @if($type!=3)
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-8 inline help-block">
                                                                            <span class="block input-icon input-icon-right">
                                                                                ...
                                                                                @else
                                                                                    <input type="number" name="conts[show_order]" value="{{$conts->show_order}}" id="show_order" class="width-100">
                                                                                @endif
                                                                                <i class="icon-leaf"></i>
                                                                            </span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-8 inline help-block">
                                                                            <span class="block input-icon input-icon-right">
                                                                                ...
                                                                                @else
                                                                                    <input type="text" name="conts[title]" value="{{$conts->title}}" required="" id="title" class="width-100">
                                                                                @endif
                                                                                <i class="icon-leaf"></i>
                                                                            </span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-5 inline help-block">
                                                                            ...
                                                                            @if($conts!='')
                                                                                ...
                                                                                （logo原图：<img src="{{asset($conts->pic)}}" style="width: 100px;height: 80px;" alt="">）
                                                                                </span>
                                                                            @endif
                                                                    ...
                                                                    <div class="form-group">
                                                                    	...
                                                                    	<div class="col-xs-12 col-sm-8 inline help-block">
                                                                    		<span class="block input-icon input-icon-right">
                                                                                ...
                                                                                @else
                                                                                    <input type="text" name="conts[link_addr]" value="{{$conts->link_addr}}" id="link_addr" class="width-100" value="">
                                                                                @endif
                                                                    			<i class="icon-leaf"></i>
                                                                    		</span>
                                                                    	</div>
                                                                           ...
                                                                           <span class="block input-icon input-icon-right">
                                                                               @if($conts!='')
                                                                                <div class="radio inline">
                                                                                    <label>
                                                                                        <input type="radio" name="conts[show_tag]" value="0" title="0" class="ace" checked="true"}}>
                                                                               ...
                                                                               @else
                                                                                <div class="radio inline">
                                                                                    <label>
                                                                                        <input type="radio" name="conts[show_tag]" value="0" title="0" class="ace" {{$conts->show_tag==0?"checked":''}}>
                                                                                        <span class="lbl"> 显示 </span>
                                                                                    </label>
                                                                                </div>
                                                                                <div class="radio inline">
                                                                                    <label>
                                                                                        <input type="radio" name="conts[show_tag]" value="1" title="1" class="ace" {{$conts->show_tag==1?"checked":''}}>
                                                                                        <span class="lbl"> 隐藏 </span>
                                                                                    </label>
                                                                                </div>
                                                                               @endif
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="inputWarning" class="col-xs-12 col-sm-2 control-label no-padding-right">修改人</label>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-xs-12 col-sm-8 inline help-block">
                                                                            <span class="block input-icon input-icon-right">
                                                                                ...
                                                                                @else
                                                                                     <input type="datetime-local" name="conts[time]" value="{{$conts->time}}" class="width-100">
                                                                                @endif
                                                                                <i class="icon-leaf"></i>
                                                                            </span>
                                                                        </div>
